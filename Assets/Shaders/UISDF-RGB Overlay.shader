Shader "UI/SDF-RGB Overlay" {
	Properties {
		[PerRendererData] _MainTex ("Sprite Texture", 2D) = "white" {}
		_Color ("Tint", Vector) = (1,1,1,1)
		_Gradient ("Gradient", Float) = 1
		_Border ("Border Shift", Range(-0.5, 0.5)) = 0
			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat0.x = abs(u_xlat2.x) + abs(u_xlat0.x);
					    u_xlat0.x = u_xlat0.x * _MainTex_TexelSize.w;
					    u_xlat0.x = u_xlat0.x / _Gradient;
					    u_xlat0.x = min(u_xlat0.x, 1.0);
					    u_xlat1 = texture(_MainTex, vs_TEXCOORD0.xy);
					    u_xlat2.x = u_xlat1.x + _Border;
					...
					;
					    u_xlat0.yz = u_xlat2.xy * u_xlat1.xy;
					    u_xlat0.xy = u_xlat0.xz * u_xlat0.xy;
					    SV_Target0.w = u_xlat0.y * u_xlat0.x;
					    return;
					}"
				}
				SubProgram "d3d11 " {
					...
					;
					    u_xlat0.yz = u_xlat2.xy * u_xlat1.xy;
					    u_xlat0.xy = u_xlat0.xz * u_xlat0.xy;
					    u_xlat4 = u_xlat0.x * u_xlat0.y + -0.00100000005;
